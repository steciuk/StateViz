...
export type ReactRenderer = {
	...
	// 16.9+
	overrideHookState?: (fiber: Fiber, id: number, path: Array<string | number>, value: any) => void;
	// 17+
	overrideHookStateDeletePath?: (fiber: Fiber, id: number, path: Array<string | number>) => void;
	// 17+
	...
	// 16.7+
	overrideProps?: (fiber: Fiber, path: Array<string | number>, value: any) => void;
	// 17+
	overridePropsDeletePath?: (fiber: Fiber, path: Array<string | number>) => void;
	// 17+
